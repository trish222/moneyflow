          ...
          <div className="w-full px-4 md:px-8 py-4">
            <div className="flex items-center justify-between gap-8">
              ...
              <div className="flex gap-4 items-center flex-shrink-0">
                <button className="text-gray-300 hover:text-purple-400 transition cursor-pointer">
                  🌙
                </button>
                <button className="text-gray-300 hover:text-purple-400 transition cursor-pointer">
                  ⚙️
                </button>
                <button className="w-8 h-8 rounded-full bg-purple-600 text-white flex items-center justify-center hover:bg-purple-700 transition cursor-pointer">
                  👤
                </button>
              </div>
            </div>
